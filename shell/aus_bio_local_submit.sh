...
export TENSOR_CPU_MEM_MAX=${TENSOR_MEM_MAX:-12000000000} #Certain operations that do bulk operations over matricies will batch to keep RAM usage within this amount (in bytes)
export TENSOR_GPU_MEM_MAX=${TENSOR_MEM_MAX:-1500000000} #Certain operations that do bulk operations over matricies will batch to keep GPU memory usage within this amount (in bytes)
