...
export TENSOR_GPU_MEM_MAX=${TENSOR_GPU_MEM_MAX:-5000000000} #Certain operations that do bulk operations over matricies will batch to keep GPU memory usage within this amount (in bytes)
